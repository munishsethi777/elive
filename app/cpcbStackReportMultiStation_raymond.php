...
<?include("cpcbHeader_raymond.php");?>
<?include("cpcbMenu_raymond.php")?>
...
<input id="lastDataFromDate" type="hidden" name="lastDataFromDate" >
<input id="lastDataDate" type="hidden" name="lastDataDate" >
<input id="isNextPage" type="hidden" name="isNextPage" >
<input id="isPrevPage" type="hidden" name="isPrevPage" >
...
<div style="margin:auto;width:1200px;min-height:250px;margin-top:3px;padding:4px;" class="ui-widget-content">
    <div class="ui-widget-content" style="display: none;width:70%;height:46px;float:left">
        <div style="display: none;float:left;line-height:17px;height:30px;padding:10px 0px 0px 4px;">Select Data Type</div>
    ...
    <div id="searchTabs" style="width:330px;padding:5px;float:right;display:none">
        <ul>
        ...
        <div id="advanceSearch" style="padding:10px;width:auto;height:auto">
            ...
            <div class="button" onClick="javascript:submitCombustionReport(null)" style="margin-top:5px;margin-left:5px;">
...
<div style="display:block;width:1200px;margin:auto;margin-top:10px;">
    ...
    <br/>
    <div id="flowVideoDiv" style="float:right">
	</div> 
</div>
