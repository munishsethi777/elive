...
var options = Highcharts.setOptions(Highcharts.theme);
   ...
   // var options;
    ...
    function getAllLocationsAndStations(){
        $.getJSON("ajax_cpcb.php?method=requestAllLocationsAndStationsJSON&folderType=aqmsp",function(data){
            $(".locationsSelectDiv").html("<select class='locationsSelect' name='locationsSelect' onChange='locationChange(\"aqmsp\")'></select>");
...
<input type="hidden" name="stationType" id="stationType" value="aqmsp" />
